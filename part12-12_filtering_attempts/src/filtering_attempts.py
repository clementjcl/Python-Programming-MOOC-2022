...
def passed_students(attempts: list, course: str):
    list_passed = filter(lambda attempt : attempt.course_name == course and attempt.grade >= 1, attempts)
    return sorted(map(lambda attempt : attempt.student_name, list_passed))
